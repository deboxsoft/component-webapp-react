...
import { Theme } from '@deboxsoft/component-webapp-react/es/theme';
...
export type ThemedStyledProps<P, T> = P extends {theme?: any} ? P : P & ThemeProps<T>; // fix Nurdiansyah
export type StyledProps<P, T = DefaultTheme> = ThemedStyledProps<P, AnyIfEmpty<T>>; // fix Nurdiansyah
...
> extends ThemedStyledFunctionBase<C, T, O, A> {
    ...
    ): ThemedStyledFunction<C, T, U & NewA, A | keyof NewA>; // Fix Nurdiansyah O => U
...
type WithOptionalTheme<P, T> = P extends {theme?: any} ? Partial<P> : Partial<P> & {
  theme?: T;
}; // fix Nurdiansyah override default theme dibuat optional/partial harus di ada defaultProps
...
// tslint:disable-next-line:no-empty-interface
export type DefaultTheme = Theme; // fix Nurdiansyah
